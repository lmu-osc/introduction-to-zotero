...
## Keeping the .bib File Updated Outside of Zotero

By default, exporting a libary from Zotero will create a bibliography file in your destination directory that is not automatically updated once you add/change references in Zotero. In order to have a reference.bib file that is dynamically updated (see the [discussion on the Zotero forum here](https://forums.zotero.org/discussion/89720/keeping-a-bibtex-file-per-collection-in-sync-with-zotero)), you need to first install the [BetterBibTeX plugin](https://retorque.re/zotero-better-bibtex/).

::: panel-tabset

## 1. Export Library

![Right-click on the collection to export and then click Export Library.](/assets/betterbibtex-automatic-updates/01-export-libary)

## 2. Select BetterBibTeX
...
To test the automatic updates, you can add a new paper to your library. 
