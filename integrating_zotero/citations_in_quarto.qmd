...
2.  Save this file in your project directory where your Quarto document is located as `references.bib`
3.  Add the following to your YAML header: `bibliography: references.bib`, like this:
...
<!-- For example, extending the `references.bib` example, based on the entry in Zotero, you can cite the Palmer Penguins data set from 2022 by Allison Horst with the citation key `@horstPalmerArchipelagoPenguins2022a`. You would use this citation key in your document to insert a citation to this reference. -->
